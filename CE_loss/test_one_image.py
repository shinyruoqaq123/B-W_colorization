...
def main():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='../model/models/',
                        help='path for saving trained models')
    parser.add_argument('--test_img_path', type=str, default='../model/models/',
                        help='path for saving trained models')
    parser.add_argument('--output_img_path', type=str, default='../model/models/',
                        help='path for saving trained models')
    ...
    image = load_image(args.test_img_path)
    ...
    # print(color_img)
    # break
    color_name = args.output_img_path
